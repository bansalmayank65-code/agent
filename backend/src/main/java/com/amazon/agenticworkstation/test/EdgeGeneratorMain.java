...
public class EdgeGeneratorMain {
	...
	// command-line arg.
	public static String TASK_JSON_PATH = "C:\\Users\\bansa\\turing\\agenticWorkstation\\backend\\test\\tasks_files\\task-approval.json";
	...
	public static void main(String[] args) {
		if (TASK_JSON_PATH != null && !TASK_JSON_PATH.isBlank()) {
			...
			try {
				...
				System.out.println();
				System.out.println("----------------------");
				System.out.println("Total edges: " + (edges != null ? edges.size() : 0));
			} catch (Exception ex) {
